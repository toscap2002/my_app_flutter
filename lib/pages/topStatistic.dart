...
class TopStatistics extends StatefulWidget {
  ...
  TopStatistics({super.key, required this.userID, required this.namePS, required this.userTag});
...
class _TopStatisticsState extends State<TopStatistics> {
  ...
  late Future<Player> _topStatistics;

  Future<Player> fetchTopStatistics(String playerTag) async {
    try {
  ...
  void initState() {
    super.initState();
    _topStatistics = fetchTopStatistics(widget.userTag);
  }
